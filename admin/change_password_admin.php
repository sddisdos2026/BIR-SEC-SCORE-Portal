        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <form action="code.php" method="POST">
                    ...
                    <div class="col-md-4">
                    <a href="users_edit?id=<?= $user['data']['id']; ?>" class="btn btn-danger btn-sm"> Back </a>
                      <button type="submit" name="changePasswordAdmin" class="btn bg-primary text-white btn-sm" title="Must contain at least one number and one uppercase and lowercase letter, and at least 12 or more characters">Update</button>
                    </div>
                        <?php 
                    } else {
