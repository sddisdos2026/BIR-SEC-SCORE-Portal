<div class="table-responsive p-0">
                <table id="myTable7" class="table align-items-center mb-0">
                    <colgroup>
					            <col width="5%">
					            <col width="20%">
					            <col width="25%">
                  ...
                  <tbody>
                    ...
                    <?php 
                      $request = approved_pp('request', $email);
        ...
        <div class="modal-content shadow-lg border-0">
            ...
            <div class="modal-body p-4">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <label class="text-xs font-weight-bold text-muted center">Transmittal Slip</label>
                            <?php
                            $id = $requestItem['id'];
                            $query2 = "SELECT * FROM transmittal_slip where request_id = $id";
                            ...
                            if ($result2 && mysqli_num_rows($result2) > 0) {
                                ...
                                $hashed_folder = $row2['file_path'];

                                $file_name = "Transmittal_Slip_" . $reference_number . ".pdf";
                                $transmittal_slip_path = $hashed_folder . 'Transmittal_Slip/' . $file_name;
                            ?>

                            <a href="<?= $transmittal_slip_path; ?>" class="btn btn-link text-success text-gradient px-3 mb-0" download>
                                        <i class="fa-solid fa-download me-1"></i> <?php echo $file_name; ?>
                                    </a>
