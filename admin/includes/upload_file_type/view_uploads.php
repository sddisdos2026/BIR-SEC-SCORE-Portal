...
<table id="myTable" class="table table-striped" style="width:100%">
    ...
    <tbody>
        ...
        ?>
                    ...
                    <div class="d-flex px-2 py-1">
                        <div class="d-flex flex-column justify-content-center">
                          <p class="text-sm text-secondary mb-0">
                            ...
                            <a href="" data-bs-toggle="modal" data-bs-target="#approver<?= $uploadItem['id']; ?>" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
                          </p>
                        </div>
                    </div>
            ...
            <?php include('view_uploads_modal.php'); ?>
...
<table id="myTable" class="table table-striped" style="width:100%">
    ...
    <tbody>
        ...
        <?php 
            $upload = view_uploads_head('upload');
        ...
        ?>
                ...
                <td>
                    <div class="d-flex px-2 py-1">
                        <div class="d-flex flex-column justify-content-center">
                          <p class="text-sm text-secondary text-center mb-0">
                            <a href="<?= $uploadItem['file_path']; ?>" target="_blank" title="Open"><i class="fa fa-file" aria-hidden="true"></i></a>
                            <a href="file_upload_download.php?filename=<?= $uploadItem['filename']; ?>" title="Download"><i class="fa fa-paperclip" aria-hidden="true"></i></a>
                            <a href="" data-bs-toggle="modal" data-bs-target="#approver<?= $uploadItem['id']; ?>" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
                          </p>
