...
<div class="modal fade" id="approver<?= $uploadItem['id']; ?>" tabindex="0" role="dialog" aria-hidden="true">
...
<!-- Open File Modal -->
<div class="modal fade" id="open_file_modal<?= $uploadItem['id']; ?>" tabindex="0" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <!-- <form action="code.php" method="POST"> -->
