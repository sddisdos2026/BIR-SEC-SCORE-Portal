      ...
      <div class="card z-index-2">
        ...
        <div class="card-footer bg-gradient-dark border-radius-lg mx-3 mb-3 p-3">
          <h6 class="text-white font-weight-bolder mb-0">
            Work in progress <i class="fa fa-cogs text-danger ms-2"></i>
          </h6>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-4 col-12 mb-4">
      <div class="card h-100">
        ...
        <div class="card-body p-3">
          ...
          ?>
                <li class="list-group-item border-0 d-flex justify-content-between align-items-center ps-0 mb-2 border-radius-lg bg-gray-100 p-3">
                  <!-- FIXED: Added ms-3 to give a nice left margin to the text block -->
                  <div class="d-flex flex-column justify-content-center ms-3">
                    <h6 class="mb-1 text-dark font-weight-bold text-sm leading-tight"><?= htmlspecialchars($requestItem['requested_by']);?></h6>
                    <span class="text-xs text-secondary mb-0"><?= htmlspecialchars($requestItem['email']); ?></span>
                  </div>
                  <div class="d-flex align-items-center me-3">
                    <span class="badge badge-sm bg-gradient-warning"><?= htmlspecialchars($requestItem['status']); ?></span>
                  </div>
                </li>
          <?php
              }
